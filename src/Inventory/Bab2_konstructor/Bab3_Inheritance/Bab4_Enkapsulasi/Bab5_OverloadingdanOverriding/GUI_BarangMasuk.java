...
public class GUI_BarangMasuk extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(BarangMasuk, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void BarangMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BarangMasukActionPerformed
        ...
        if(cmb_satuan.getSelectedIndex() == 0){
            ...
            brgMasuk.setInputUser(1, jum);
            memo.append("Jumlah Barang : "+Integer.toString(brgMasuk.getJumlah()));
        }else if(cmb_satuan.getSelectedIndex() == 2){
            brgMasuk.setInputUser(2, jum);
            memo.append("Jumlah Barang : "+Integer.toString(brgMasuk.getJumlah()));
        }else if(cmb_satuan.getSelectedIndex() == 3){
            brgMasuk.setInputUser(3, jum);
            memo.append("Jumlah Barang : "+Integer.toString(brgMasuk.getJumlah()));
        }
        if(berhasil == 1){
