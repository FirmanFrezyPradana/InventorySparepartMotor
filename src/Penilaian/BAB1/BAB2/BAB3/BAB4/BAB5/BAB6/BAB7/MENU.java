...
public class MENU extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gui_mhs = new javax.swing.JMenuItem();
        ...
        gui_mhs.setText("GUI_MAHASISWA");
        gui_mhs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gui_mhsActionPerformed(evt);
            }
        });
        jMenu3.add(gui_mhs);

        gui_matkul.setText("GUI_MATAKULIAH");
        gui_matkul.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gui_matkulActionPerformed(evt);
            }
        });
        jMenu3.add(gui_matkul);
    ...
    private void gui_mhsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gui_mhsActionPerformed
        // TODO add your handling code here:
        Gui_Mahasiswa mhs = new Gui_Mahasiswa(); 
        mhs.show();
        
    }//GEN-LAST:event_gui_mhsActionPerformed

    private void gui_matkulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gui_matkulActionPerformed
        // TODO add your handling code here:
        GUI_Matkul matkul = new GUI_Matkul();
        matkul.show();
    ...
    private void gui_penilaianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gui_penilaianActionPerformed
        // TODO add your handling code here:
       GUI_Penilaian penilaian = new GUI_Penilaian();
       penilaian.show();
    ...
    private javax.swing.JMenuItem gui_mhs;
